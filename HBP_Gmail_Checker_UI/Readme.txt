WARNING this the UI version of the HBP_Gmail_Checker this is still in alpha version, not completely working.
...
of the HBP_Gmail_Checker_UI.exe executable containg the pwned accounts.
